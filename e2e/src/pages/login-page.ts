 ...
 * Locator evidence: live DOM inspection via Playwright MCP (browser_navigate + browser_snapshot)
 *   — all locators cross-validated against rendered DOM at http://localhost:5173/login
 */
